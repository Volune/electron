...
if (BUILDFLAG(ENABLE_DESKTOP_CAPTURER)) {
  ...
  ipcMainInternal.handle('ELECTRON_BROWSER_DESKTOP_CAPTURER_GET_WEB_CONTENTS_STREAM', function (event, options, stack) {
    return desktopCapturer.getWebContentsStream(event, options);
  });
}
